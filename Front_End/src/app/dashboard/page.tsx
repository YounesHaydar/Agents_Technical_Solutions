        ...
        <div className="glass-panel panel-border rounded-4xl p-6 md:p-8 reveal-up">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <p className="mono-accent text-xs uppercase tracking-widest text-muted">Editor system</p>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="glass-panel panel-border rounded-4xl p-6 md:p-8 reveal-up" style={{ animationDelay: '180ms' }}>
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-400">Add platform, URL, and localized labels for the frontend link text.</p>
                </div>
                <button
                  type="button"
          ...
          <aside className="space-y-6">
            <div className="glass-panel panel-border rounded-4xl p-6 md:p-8 reveal-up lg:sticky lg:top-28">
              <p className="mono-accent text-xs uppercase tracking-widest text-muted">Preview notes</p>
              ...
              <div className="mt-8 grid gap-3">
                {[
                  'Separate content for English and Arabic.',
                  'Social link labels can now match the frontend.',
                  'The design system stays readable under both themes.',
                ].map((item) => (
